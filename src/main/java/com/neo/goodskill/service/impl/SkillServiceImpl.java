package com.neo.goodskill.service.impl;

import com.neo.goodskill.service.SkillService;
import com.neo.goodskill.utills.KeyUtil;
import com.neo.goodskill.utills.RedisLock;
...
public class SkillServiceImpl implements SkillService {
    ...
    static {
        ...
        stock = new HashMap<>();
        orders = new HashMap<>();
        products.put("iphonex", 10);
        stock.put("iphonex", 10);
    }
